   ...
   return (
      <div className="w-full md:w-2/3 h-full flex items-center justify-center relative">
         <div className="relative w-full h-full flex flex-col p-4 md:p-8">
            ...
            <div className="relative z-20 flex items-center justify-between text-xl md:text-3xl font-bold text-white mb-auto">
               ...
               <div className="relative w-10 md:w-16 h-10 md:h-16">
                  <Image
                     src="/neu-logo.png"
