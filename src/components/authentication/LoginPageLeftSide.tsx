        ...
        <div className="relative z-20 mt-auto text-white">
          <blockquote className="space-y-2">
            <p className="text-base md:text-lg">
              A resource hub that empowers students and researchers from New Era
              University and beyond, <br /> fostering a community where
              knowledge is accessible and shared across different institutes.
            </p>
